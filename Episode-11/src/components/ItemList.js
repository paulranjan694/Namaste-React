      ...
      {items.map((item) => (
        ...
        >
          ...
          <div className="w-2/12">
            ...
            <button className={`p-1 bg-white rounded-md absolute w-20 cursor-pointer hover:shadow-lg text-sm border border-solid border-gray-500 ${item.card.info.imageId ?'mt-[-20px]': 'mt-10'}`}>Add +</button>
            </div>
        </div>
        </div>
      ))}
